               ...
               <div class="navbar-default sidebar" role="navigation">
                  <div class="sidebar-nav navbar-collapse">
                     ...
                     <ul class="nav" id="side-menu">
                        ...
                        <li>
                           <a href="XX.jsp" class=" hvr-bounce-to-right"><i class="fa fa-file-o nav_icon"></i>Maestros</a>
                        </li>
                        <li>
                           <a href="XX.jsp" class=" hvr-bounce-to-right"><i class="fa fa-file-o nav_icon"></i>Alumnos</a>
                        </li>
                        <li>
